function init()
	...
	GameRules:SetHeroSelectionTime( 45 )						-- Sets the amount of time players have to pick their hero. 
	...
	GameRules:SetPreGameTime( 10 )								-- Sets the amount of time players have between picking their hero and game start. 
